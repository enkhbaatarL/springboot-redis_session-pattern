package com.skcc.modern.pattern.redis.session.config;
...
public class RedisSessionPatternEnvironmentPostProcessor implements EnvironmentPostProcessor {

    private static final Logger logger = LoggerFactory.getLogger(RedisSessionPatternEnvironmentPostProcessor.class);
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        try {
            ...
            Resource k8sPath = new FileUrlResource("/pattern/redis_session.yml");

            // 패키지된 기본 설정값 : resources/pattern.yml
            Resource localPath = new ClassPathResource("redis_session.yml");
